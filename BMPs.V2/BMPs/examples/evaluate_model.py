...
# === Load Data ===
train_df = pd.read_csv('../BMPs/data/bace.csv')
eval_df = pd.read_csv('../BMPs/data/TRPA1_for_evaluation.csv')
...
# === Evaluate ===
accuracy, _, _, f1, roc_auc, _, all_targets, all_preds, compound_names, all_preds_binarized = trainer.evaluate(eval_loader, generate_images=True)
